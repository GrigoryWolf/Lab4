...
public class Feel {
    public static void skill(Creature creature, Feeling feeling, String reason) {
        ...
        System.out.println(creature.getName() + " " + creature.getAge()+ " человеческих лет чувствует " + feeling.getFeeling() + " из-за того, что " + reason);
        }
    public static void skill(Creature creature, Feeling feeling) {
        creature.setFeeling(feeling);
        System.out.println(creature.getName() + " " + creature.getAge()+ " человеческих лет чувствует " + feeling.getFeeling());
    }
